...
router.register(r'lineas_pedido', LineaPedidoViewSet, basename='lineas_pedido')
...
router.register(r'cuenta_bancaria', CuentaBancariaViewSet, basename='cuenta_bancaria')
router.register(r'billetera_digital', BilleteraDigitalViewSet, basename='billetera_digital')
...
router.register(r'lista_deseo', ListaDeseosViewSet, basename='lista_deseo')
router.register(r'lista_deseos_pieza', ListaDeseosPiezaViewSet, basename='lista_deseos_pieza')
router.register(r'descuento', DescuentoViewSet, basename='descuento')
router.register(r'cliente_descuento', ClienteDescuentoViewSet, basename='cliente_descuento')
